...
# class PairObjective(Objective):

#     def __init__(self, inner: Objective, outer: Objective, maximize: bool=False):
#         super().__init__(maximize)
#         self.inner = inner
#         self.outer = outer

#     def assess(self, x: torch.Tensor, t: torch.Tensor, y: torch.Tensor=None, batch_assess: bool=True) -> typing.Union[ScalarAssessment, BatchAssessment]:
        
#         x, inner_assessment = self.inner.extend(x, y, True)
#         assessment = self.objectives[-1].assess(x, t, batch_assess=True) + inner_assessment
#         return assessment

#     @abstractmethod
#     def extend(self, x: torch.Tensor, t: torch.Tensor, y: torch.Tensor=None, batch_assess: bool=True) -> (
#         typing.Tuple[torch.Tensor, typing.Union[ScalarAssessment, BatchAssessment]]
#     ):
#         x, inner_assessment = self.inner.extend(x, y, True)
#         x, outer_asssessment = self.objectives[-1].extend(x, batch_assess=True)
#         return x, outer_asssessment + inner_assessment
