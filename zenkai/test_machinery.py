...
#     def test_call_with_one_network_and_singular(self):

#         net = nn.Linear(2, 2)

#         func = mac.NNFunc(net, singular=True)
#         y = func(th.rand(3, 2))
#         assert y.size() == th.Size([3, 2])

#     def test_call_with_one_network_and_multiple(self):

#         net = nn.Linear(2, 2)

#         func = mac.NNFunc(net, singular=False)
#         x = th.rand(2, 3, 2)
#         ys = func(x)
#         assert ys.size() == th.Size([2, 3, 2])


# class TestNNParamFunc:

#     def test_call_with_one_network_and_singular(self):

#         net = nn.Linear(2, 2)

#         func = mac.NNParamFunc(net, theta=th.Tensor(3, 2), singular=True)
...
#         func = mac.NNParamFunc(net, theta=th.Tensor(3, 2), singular=False)
#         v = nn.utils.parameters_to_vector(net.parameters())
#         vs = [th.clone(v) * 0.1, th.clone(v) * 0.2]
#         ys = func(vs)
#         assert ys[0].size() == th.Size([3, 2])
#         assert ys[1].size() == th.Size([3, 2])
